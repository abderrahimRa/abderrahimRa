...
<table>
  ...
  <tr>
    ...
    <td>Frontend Developer and Optimization Enthusiast</td>
  </tr>
</table>
  ...
  <tr>
    <td width="50%" valign="top" bgcolor="#F8FAFC">
      ...
      <ul>
        ...
        <li>Fraud-risk oriented workflow</li>
        <li>Search and discovery logic</li>
    ...
    <td width="50%" valign="top" bgcolor="#FFFBEB">
      ...
      <ul>
        ...
        <li>Multi-level facility capacity constraints</li>
        <li>Flow matrix configuration</li>
  ...
  <tr>
    <td width="50%" valign="top" bgcolor="#F0FDFA">
      ...
      <ul>
        ...
        <li>Heart-rate and temperature sensing</li>
        <li>Sensor data collection and MySQL storage</li>
    ...
    <td width="50%" valign="top" bgcolor="#F8FAFC">
      ...
      <strong>Highlights</strong>
      <ul>
        <li>QR-code table access</li>
        <li>Menu browsing without login</li>
        <li>Cart and order workflow</li>
  ...
  <tr>
    <td width="50%" valign="top" bgcolor="#FFF7ED">
      ...
      <ul>
        ...
        <li>Webhook verification flow</li>
    ...
    <td width="50%" valign="top" bgcolor="#ECFEFF">
      ...
      <ul>
        ...
        <li>Super admin, operator, and retailer workflow</li>
        <li>Recharge transaction management</li>
